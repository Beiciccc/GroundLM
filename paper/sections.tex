...
and target directions held out from the map), versus an in-sample $0.977$---a $0.006$
gap that matches the native direction's own cross-split self-consistency ($0.994$), so
