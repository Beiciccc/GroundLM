...
Qwen2.5-7B, Mistral-7B, Gemma-2-9B), we report: (i)~within the answer-present
stratum (overlap held constant) a support contrast is decodable on all four families
(near-ceiling, $0.99$ raw on the collision-free cells; $0.76$--$0.88$ after purging
confidence), but a \emph{no-context ablation} shows it is mostly question--answer
compatibility---removing the context barely changes it ($0.95$--$0.98$ raw,
confidence-purged unchanged)---and it coincides with synthetic factuality by
construction; we therefore claim \emph{no} context-grounding signal, even an
overlap-controlled one. (ii)~This contrast
